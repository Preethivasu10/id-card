        ...
        <div className="row  d-flex justify-content-center align-items-center">
          <div className="col-md-8 text-center">
            <div className="col-md-8">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHU1P09_zNi1ldO8i_rwYsqNmL_q03FNS61X7XEx8sMbdAKbFUQcx7RtZicnkP_lTRCLg&usqp=CAU"
               className="m-4" width='200px' height='100px'/>
            </div>
          </div>
        ...
        <div className="d-flex justify-content-center align-items-center">
          <div className="leftcontainer">
            <div className="certificate" id="certificate" ref={CertificateRef}>
              <img className="ribbon" src="./logos.jpg" alt="ribbon" />
              <div className="links">
                <a href="https://wowhr.in/">www.jsp.in</a>
